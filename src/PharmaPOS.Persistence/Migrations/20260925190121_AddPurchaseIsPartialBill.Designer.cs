...
namespace PharmaPOS.Persistence.Migrations
{
    ...
    [Migration("20260925190121_AddPurchaseIsPartialBill")]
    partial class AddPurchaseIsPartialBill
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Inventory.NonSaleableStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NonSaleableStocks");
                });

            modelBuilder.Entity("PharmaPOS.Domain.Entities.Inventory.ShortageBookEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BranchId", "Status", "RecordedAtUtc");

                    b.ToTable("ShortageBookEntries");
                });
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Purchases.ExpirySupplierClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CreditSettlementKind")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ExpirySupplierClaims");
                });

            modelBuilder.Entity("PharmaPOS.Domain.Entities.Purchases.ExpirySupplierClaimItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ExpirySupplierClaimItems");
                });
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.BillingCounter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BillingCounters");
                });

            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.CounterSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.ReturnReason", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.ReturnRefund", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("RefundDateUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.Sale", b =>
                {
                    ...
                    b.Property<int?>("CounterSessionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.SaleItem", b =>
                {
                    ...
                    b.Property<decimal>("LooseQuantity")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.SaleReturn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("CustomerReceivesAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("ManagerOverrideReason")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("ManagerOverrideUsed")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("RewardPointsRestored")
                        .HasColumnType("int");

                    b.Property<int>("RewardPointsReversed")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.SaleReturnItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("BatchMismatchApproved")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("PackagingDamaged")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.System.AuditLogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.System.CompanyProfile", b =>
                {
                    ...
                    b.Property<int>("CreditNoteValidityDays")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("InvoicePaperSize")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SaleReturnAllowedDays")
                        .HasColumnType("int");

                    b.Property<bool>("SaleReturnBlockExpired")
                        .HasColumnType("bit");

                    b.Property<bool>("SaleReturnBlockRefrigerated")
                        .HasColumnType("bit");

                    b.Property<bool>("SaleReturnBlockScheduleDrugs")
                        .HasColumnType("bit");

                    b.Property<decimal>("SaleReturnHighValueThreshold")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<bool>("SaleReturnRefundOriginalPaymentMode")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Purchases.ExpirySupplierClaimItem", b =>
                {
                    b.HasOne("PharmaPOS.Domain.Entities.Purchases.ExpirySupplierClaim", "Claim")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.CounterSession", b =>
                {
                    b.HasOne("PharmaPOS.Domain.Entities.Sales.BillingCounter", "Counter")
                        .WithMany("Sessions")
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.CreditNote", b =>
                {
                    ...
                    b.HasOne("PharmaPOS.Domain.Entities.Sales.SaleReturn", "SaleReturn")
                        .WithOne("CreditNote")
                        .HasForeignKey("PharmaPOS.Domain.Entities.Sales.CreditNote", "SaleReturnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.Sale", b =>
                {
                    ...
                    b.HasOne("PharmaPOS.Domain.Entities.Sales.CounterSession", "CounterSession")
                        .WithMany()
            ...
            modelBuilder.Entity("PharmaPOS.Domain.Entities.Sales.SaleReturnItem", b =>
                {
                    ...
                    b.HasOne("PharmaPOS.Domain.Entities.Sales.SaleItem", "SaleItem")
                        .WithMany()
