...
public interface IMastersService
{
    ...
    Task<Result> DeleteSupplierAsync(int id, CancellationToken ct = default);
    ...
    Task<Result> DeleteCustomerAsync(int id, CancellationToken ct = default);
    ...
    Task<Result> DeleteManufacturerAsync(int id, CancellationToken ct = default);
    ...
    Task<Result> DeleteEmployeeAsync(int id, CancellationToken ct = default);
    ...
    Task<Result> DeleteMedicineAsync(int id, CancellationToken ct = default);
}
